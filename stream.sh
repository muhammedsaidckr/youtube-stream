...
FFMPEG_CMD="ffmpeg -loglevel verbose -f x11grab -video_size ${RESOLUTION} -framerate ${FRAMERATE} -i ${DISPLAY}"
...
# Force constant bitrate to ensure YouTube accepts the stream
